    ...
    <Sidebar className="flex flex-col justify-between h-full shadow-md">
      <SidebarContent>
        <SidebarGroup className="gap-2">
          <SidebarGroupLabel className="flex justify-left items-center text-xl text-black font-bold px-4 py-6 ">
            ...
            <SidebarMenu>
              {items.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild className='hover:bg-gray-600 hover:text-white rounded-4xl'>
                    <Link
                      to={item.url}
        ...
        >
          <div className="flex-shrink-0">
            {img ? (
              ...
              <div className="p-2 bg-gray-200 rounded-full shadow-inner hover:bg-gray-300 
