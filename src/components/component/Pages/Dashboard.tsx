    ...
    <div className="flex flex-col gap-6 w-full overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
        ...
        <div className="bg-white border-1 border-gray-300 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 rounded-xl overflow-hidden">
          <div className="p-6 flex items-start justify-between border-b border-gray-100">
            <div>
              <p className="text-sm font-medium text-gray-400 mb-1">Simple Users</p>
              <h2 className="text-3xl font-bold text-gray-900">{simpleUserCount}</h2>
            </div>
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-blue-500 font-medium">{simpleUserCount} users</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-1 border-gray-300 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 rounded-xl overflow-hidden">
          <div className="p-6 flex items-start justify-between border-b border-gray-100">
            <div>
              <p className="text-sm font-medium text-gray-400 mb-1">Admin Users</p>
              <h2 className="text-3xl font-bold text-gray-900">{adminUserCount}</h2>
            </div>
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-red-500 font-medium">{adminUserCount} users</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-1 border-gray-300 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 rounded-xl overflow-hidden">
          <div className="p-6 flex items-start justify-between border-b border-gray-100">
            <div>
              <p className="text-sm font-medium text-gray-400 mb-1">Management Users</p>
              <h2 className="text-3xl font-bold text-gray-900">{managementUserCount}</h2>
            </div>
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500">Management users</span>
              <span className="text-green-500 font-medium">{managementUserCount} users</span>
            </div>
          </div>
        </div>
      </div>
